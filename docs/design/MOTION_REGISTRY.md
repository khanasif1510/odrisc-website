...
| MOT-PAT-001 | Patient Journey Timeline   | PAT-PG-001 | Patient  | Explain pregnancy progression                  | Scroll entry         | Static timeline         | Patient Product Status    | Motion owner      | Proposed |
