# ODRISC Public Website Route Registry

## Purpose

This document records every approved, proposed, implemented, redirected, and retired public website route.

Public routes must comply with:
...
| Page ID | Route | Zone | Audience | Page type | Priority | Product-status dependency | Indexation | CTA | Owner | Status |
|---|---|---|---|---:|---|---|---|---|---|
...
| LEG-PG-002 | `/terms/` | Legal | Shared | Legal page | P0 | Legal approval | Index | None | Legal owner | Proposed |
