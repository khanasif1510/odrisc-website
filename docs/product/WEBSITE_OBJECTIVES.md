# ODRISC Website — Objectives

## Document Status

**Status:** Foundational
**Authority:** Canonical website objectives
**Website:** `odrisc.com`
...
This document defines what the ODRISC public website must accomplish.
...
The website must not be treated as a collection of independent marketing pages.

It must function as a connected product-communication system that helps each visitor:

1. Recognize that ODRISC is relevant to them
2. Understand the problem ODRISC addresses
3. Understand what ODRISC does
4. Understand what ODRISC does not do
5. Identify the most relevant product pathway
6. Develop appropriate trust
7. Take a clear next action

The website must represent one ODRISC platform while providing distinct experiences for Patients and healthcare providers.
...
## 2.1 Product Communication Role

The website must explain ODRISC as a connected maternal and fetal intelligence platform.
...
Risk assessment, weight monitoring, nutrition, physical activity, maternal intelligence, fetal growth intelligence, report extraction, clinical monitoring, and Provider workflows must be presented as connected parts of one product ecosystem.

---

## 2.2 Audience Navigation Role

The website must guide visitors into the correct experience.
...
The website must convert relevant visitors into appropriate next steps.
...
## 2.6 Validation and Partnership Role
...
# 3. Website Objective Hierarchy

Website objectives must be interpreted through the following hierarchy.

## 3.1 Level One — Immediate Understanding
...
## 3.2 Level Two — Audience Relevance

After selecting an audience, the website must reflect the visitor's needs.
...
## 3.3 Level Three — Trust and Credibility

The website must provide sufficient trust for the visitor to continue.
...
## 3.4 Level Four — Deeper Product Understanding

The website must help visitors understand how ODRISC connects:
...
This product story must be visible across both audience journeys.

---

## 3.5 Level Five — Action

Every significant page must support one clear next action.
...
## 3.6 Level Six — Long-Term Relationship
...
The primary website objective is:

> To help Patients and healthcare providers understand why pregnancy requires longitudinal maternal and fetal monitoring, how ODRISC supports that understanding, and which next action is appropriate for them.

This objective contains five connected requirements.
...
## 4.2 Explain the ODRISC Approach
...
## 4.3 Establish the Role of ODRISC
...
## 4.4 Connect the Two Audiences

The website must show that Patients and Providers are not isolated users of unrelated products.

They participate in one connected pregnancy-care ecosystem.
...
## 4.5 Enable an Appropriate Next Step
...
# 5. Shared Website Objectives

The following objectives apply across the Patient and Provider experiences.

## 5.1 Communicate One Product Identity

The website must consistently position ODRISC as:
...
## 5.2 Explain Longitudinal Intelligence

The website must make longitudinal intelligence understandable.
...
## 5.3 Communicate Patient-Provider Collaboration

The website must repeatedly reinforce that ODRISC is designed to strengthen collaboration.
...
## 5.4 Separate Current Capabilities From Future Direction
...
## 5.5 Maintain Clinical Responsibility
...
## 5.6 Create a Coherent Website Story

The website must tell one connected story.

The shared narrative is:

```text
Pregnancy information is fragmented
↓
Pregnancy evolves continuously
↓
Understanding requires longitudinal context
↓
ODRISC connects maternal and fetal information
↓
Patients and Providers gain greater clarity
↓
Earlier recognition becomes possible
↓
Monitoring becomes more informed
↓
Maternal and fetal outcomes may be better supported
```

Each audience journey may express this differently, but the central logic must remain consistent.

---

## 5.7 Support Progressive Disclosure

The website must provide information in layers.

A visitor should be able to understand the main point without reading every detail.
...
The website structure must support future additions without losing coherence.
...
# 6. Audience Gateway Objectives

The audience gateway is the first major decision point in the website experience.

Its purpose is to guide each visitor toward the most relevant journey.

## 6.1 Immediate Recognition
...
The gateway must present two primary choices only.
...
## 6.3 Explain the Difference

Each gateway option must provide a brief explanation.
...
## 6.4 Preserve One Brand

The gateway must not create the impression that ODRISC operates two separate companies, products, or websites.
...
## 6.6 Avoid Permanent Misclassification

Audience selection must not permanently restrict users.

A healthcare professional may need to view Patient content.

A Patient may want to share Provider information with a clinician.

An institutional stakeholder may need to explore both.

Audience selection should guide content, not prevent access.

---

## 6.7 Support Analytics
...
## 6.8 Support Accessible Interaction
...
# 7. Patient Journey Objectives

The Patient journey must help women understand how ODRISC may support them before and during pregnancy.

## 7.1 Establish Personal Relevance

The Patient experience must allow users to recognize whether ODRISC is relevant to them.
...
## 7.3 Encourage Informed Participation

The Patient journey must support active but appropriately bounded participation.
...
## 7.5 Present Weight Without Stigma
...
## 7.6 Explain Maternal Monitoring
...
## 7.7 Explain Fetal Growth Appropriately
...
## 7.8 Clarify the Role of Healthcare Professionals
...
## 7.10 Guide Toward One Primary Action

Each Patient page must have one primary action based on its purpose.
...
# 8. Provider Journey Objectives

The Provider journey must help healthcare professionals understand the clinical, operational, and collaborative value of ODRISC.

## 8.1 Establish Clinical Relevance
...
## 8.2 Respect Clinical Expertise

The Provider journey must treat clinicians as informed decision-makers.
...
## 8.3 Explain the Clinical Model
...
## 8.5 Demonstrate Explainability

Provider content must show that ODRISC outputs are based on reviewable information.
...
## 8.6 Separate Decision Support From Diagnosis
...
## 8.7 Communicate Validation Status
...
## 8.9 Support Different Provider Segments
...
## 8.10 Guide Toward Professional Action

Provider pages must support one primary action.
...
# 9. Shared Patient-Provider Objectives

The website must demonstrate how the two audience journeys connect.

## 9.1 Present One Pregnancy Story

The Patient and Provider experiences must refer to the same underlying pregnancy journey.
...
## 9.2 Show Complementary Roles

The website must show that:
...
## 9.4 Preserve Appropriate Information Depth

Patient and Provider views must not contain identical clinical detail.
...
## 9.5 Support Consent and Privacy

The website must communicate that Patient information sharing requires appropriate consent and access control.

It must not imply unrestricted Provider access.

The exact consent and sharing model must be defined before related functionality is publicly described as available.

---

# 10. Product Communication Objectives

The website must communicate the product accurately and consistently.

## 10.1 Explain the Platform Before Individual Features

The website must establish the ODRISC platform model before presenting detailed tools.

The preferred order is:

```text
Pregnancy care problem
↓
Longitudinal ODRISC approach
↓
...
Individual tools must not become the entire product identity.

---

## 10.2 Group Capabilities Coherently
...
## 10.3 Describe Current Product Status

Every capability description must align with:
...
## 10.4 Explain How Capabilities Connect

The website must show relationships such as:
...
The product should not appear as separate modules that never interact.

---

## 10.5 Use Consistent Terminology

The website must use definitions governed by:
...
## 10.6 Communicate Artificial Intelligence Responsibly

Where artificial intelligence is discussed, the website must explain its specific role.
...
# 11. Trust and Credibility Objectives

Trust is a core website outcome.

## 11.1 Build Trust Through Clarity
...
## 11.2 Build Trust Through Transparency
...
## 11.3 Build Trust Through Professional Credibility
...
## 11.4 Build Trust Through Evidence
...
Patient pages should not become research papers.

Provider pages must provide sufficient methodological depth.

---

## 11.5 Build Trust Through Design
...
## 11.6 Build Trust Through Consistency
...
## 11.7 Build Trust Through Founder Story

The founder story may explain the personal motivation behind ODRISC.
...
# 12. Clinical Safety and Boundary Objectives

The website must protect Patients, Providers, and ODRISC through responsible communication.

## 12.1 State the Supportive Role
...
## 12.2 Avoid Diagnostic Language
...
## 12.3 Avoid Guaranteed Outcome Language
...
## 12.4 Include Appropriate Escalation

Patient pages that discuss symptoms, alerts, or concerning changes must include approved escalation guidance.
...
## 12.5 Communicate Data Uncertainty
...
## 12.6 Protect Against False Reassurance
...
## 12.7 Protect Against Unnecessary Anxiety
...
## 12.8 Maintain Approved Disclaimers
...
# 13. Conversion Objectives

Conversion must be purposeful, audience-specific, and aligned with product availability.

## 13.1 Conversion Definition
...
## 13.2 Patient Conversion Objectives
...
## 13.3 Provider Conversion Objectives
...
## 13.4 Institutional Conversion Objectives
...
## 13.5 Primary and Secondary Actions
...
## 13.7 Avoid Conversion Pressure
...
## 13.8 Minimize Form Friction

Forms should collect only information required for the next step.

Patient forms must avoid unnecessary clinical data collection on public marketing pages.
...
# 14. Brand and Experience Objectives

The website must express the ODRISC brand through a consistent, audience-appropriate experience.
...
The gradient should be predominantly weighted toward:

```text
#ff7680
```

with controlled transition toward:
...
## 14.3 Patient Experience Character
...
## 14.4 Provider Experience Character
...
## 14.8 Data-Visualization Objectives
...
# 15. Information Architecture and Navigation Objectives

The website information architecture must help visitors find relevant information without losing the connection to the broader ODRISC platform.
...
Patient and Provider journeys must not be separated into unrelated brand domains.

---

## 15.2 Audience-Oriented Structure
...
│
├── Provider Experience
└── Shared Company and Institutional Content
```

---

## 15.3 Patient Navigation Objectives
...
## 15.4 Provider Navigation Objectives
...
## 15.5 Shared Navigation Objectives
...
## 15.7 Navigation Depth

Visitors should be able to reach primary information without navigating through excessive levels.
...
## 15.9 Cross-Journey Linking

Patient and Provider pages may link to one another where contextually useful.
...
## 15.11 Avoid Duplicate Pages

The website must avoid publishing separate Patient and Provider pages where the content is genuinely shared.
...
## 15.12 Preserve Future Scalability
...
## 15.13 Information Architecture Success
...
# 16. Content Strategy Objectives

The website content system must communicate ODRISC consistently across Patient, Provider, institutional, and shared company pages.

## 16.1 Content Must Serve a Defined Purpose
...
## 16.2 Content Must Be Audience-Specific
...
## 16.3 Content Must Follow the Website Story

Content must follow a clear progression:
...
↓
Why current information may be fragmented
↓
How ODRISC connects information
↓
How the capability supports the audience
↓
What limitations apply
↓
...
Pages must not begin with long feature lists before establishing relevance.

---

## 16.4 Content Must Distinguish Education From Product Claims
...
## 16.5 Content Must Use Controlled Terminology

All product, clinical, and audience terminology must align with:
...
## 16.6 Content Must Remain Readable
...
## 16.7 Content Must Use Evidence Responsibly
...
## 16.8 Content Must Represent Product Status Accurately

Wording must change according to product status.
...
## 16.9 Content Must Avoid Unsupported Superlatives
...
## 16.10 Content Must Avoid Repetition Without Progression

The central ODRISC message may be reinforced across multiple pages, but each page must add new value.
...
## 16.11 Resource Content Objectives
...
## 16.12 Content Review Ownership
...
# 17. Website Storytelling Objectives

The website must communicate the ODRISC story through a structured narrative rather than disconnected statements.

## 17.1 Foundational Story

The foundational story is:

> Every pregnancy develops over time, but the information describing that pregnancy is often separated across reports, measurements, appointments, and professionals. ODRISC helps organize that information into a clearer longitudinal story for Patients and healthcare providers.

This story must remain visible throughout the website.

---

## 17.2 Story Before Features
...
## 17.3 Patient Storytelling

The Patient story should move through:

```text
My pregnancy is changing
↓
My information may feel difficult to connect
↓
ODRISC helps me understand and monitor relevant progress
↓
I can participate more meaningfully
↓
My healthcare professional remains central to my care
```

---

## 17.4 Provider Storytelling

The Provider story should move through:

```text
Pregnancy information is distributed across time and systems
↓
Isolated values may not reveal the complete trajectory
↓
ODRISC organizes longitudinal maternal and fetal information
↓
Patterns and changes become easier to review
↓
Monitoring and collaboration become more informed
```

---

## 17.5 Founder Storytelling
...
# 18. Search Engine Optimization Objectives

Search engine optimization must help relevant Patient and Provider audiences discover accurate ODRISC content.

## 18.1 SEO Must Support Audience Intent
...
## 18.6 Heading Structure Objectives
...
## 18.7 Structured Data Objectives
...
## 18.8 Internal Linking Objectives
...
## 18.9 Content Quality Objectives

SEO content must not be produced solely to increase page volume.
...
## 18.11 Multilingual SEO Objectives
...
# 19. Analytics and Measurement Objectives

Analytics must measure whether the website helps each audience understand, trust, and act.

## 19.1 Measurement Principles
...
## 19.2 Shared Analytics Objectives
...
## 19.3 Patient Analytics Objectives
...
## 19.4 Provider Analytics Objectives
...
## 19.5 Conversion-Funnel Measurement

The website must support analysis of:
...
↓
Trust or product-detail engagement
↓
Primary conversion start
↓
Primary conversion completion
```

Patient and Provider funnels must be measured separately.

---

## 19.6 Content-Effectiveness Measurement
...
## 19.8 Error and Performance Measurement
...
## 19.10 Consent Objectives

Analytics use must comply with applicable consent and privacy requirements.
...
# 20. Accessibility Objectives

The website must be usable by people with different abilities, technologies, and access needs.

## 20.1 Accessibility Standard

The website must be designed and implemented toward conformance with:
...
## 20.2 Keyboard Accessibility

All interactive elements must be usable through keyboard input.
...
## 20.3 Screen-Reader Accessibility
...
## 20.5 Motion Accessibility

All meaningful content must remain available without animation.
...
## 20.9 Data Visualization Accessibility
...
# 21. Localization and Language Objectives

The website must be capable of supporting multiple markets, languages, and cultural contexts.

## 21.1 Initial Language Context

English is the foundational documentation and implementation language.

Arabic is required for the planned Qatar commercial experience.
...
## 21.2 Localization Is More Than Translation
...
## 21.3 Arabic Experience Objectives
...
## 21.4 Market-Specific Content Objectives
...
## 21.5 Regional Clinical Context
...
The website must load and respond efficiently across devices and network conditions.

## 22.1 Performance as Trust

Performance is part of the ODRISC experience.
...
## 22.2 Core Performance Objectives
...
## 22.3 Core Web Vitals

The website should be developed to achieve strong performance against current Core Web Vitals expectations.
...
## 22.6 Third-Party Script Control

Third-party scripts must be limited to approved purposes.
...
# 23. Privacy and Data-Protection Objectives

The public website must treat privacy as a product and trust requirement.

## 23.1 Data-Minimization Objective
...
## 23.2 Separation of Marketing and Clinical Data

Public website forms must not collect detailed clinical or pregnancy information unless the form is part of an approved secure product workflow.
...
## 23.5 Patient Privacy Communication
...
## 23.6 Provider Privacy Communication
...
## 23.9 Privacy by Design

New pages, forms, integrations, and analytics events must undergo privacy review before implementation.

---

# 24. Security Objectives

The website must be designed and maintained as a secure public entry point to the ODRISC ecosystem.

## 24.1 Secure Transport

All public and authenticated website traffic must use secure encrypted transport.

---

## 24.2 Secure Configuration
...
## 24.4 Authentication Boundaries
...
# 25. Technical and Engineering Objectives

The website must be built as a maintainable, scalable, and well-governed product.

## 25.1 Documentation-First Development

Application development must follow:
...
Major implementation decisions must not be based only on temporary prompts.

---

## 25.2 Component-Based Architecture
...
## 25.4 Type Safety and Validation
...
## 25.8 Browser and Device Support
...
The website must be understandable to future developers and AI coding agents without reliance on previous chat history.

Code and documentation must remain aligned.

---

# 26. Website-to-Application Integration Objectives

The public website must provide a clear and safe transition into ODRISC product experiences.

## 26.1 Clear Destination
...
## 26.2 Patient Application Transition
...
## 26.3 Provider Platform Transition
...
# 27. Institutional and Partnership Objectives

The website must support evaluation by hospitals, healthcare systems, partners, and strategic stakeholders.

## 27.1 Institutional Relevance
...
## 27.5 Investor and Program Context

Investors and startup programs are shared secondary audiences.
...
## 27.6 Partnership Claim Control
...
# 28. Market-Readiness Objectives

The website must support ODRISC's planned commercial and geographic development.

## 28.1 India Objectives
...
## 28.5 Market Detection

The website may use location context to suggest relevant content, but visitors must retain control.
...
# 29. Website Governance Objectives

The website must be governed as a controlled product surface.

## 29.1 Source-of-Truth Governance

Website decisions must follow:
...
Approved design and engineering documents
```

Temporary prompts must not override approved documentation.
...
Website content and code must be version-controlled.
...
# 30. Launch Objectives

The first public website release must establish a credible and scalable foundation.

## 30.1 Launch Must Communicate the Core Identity
...
## 30.2 Launch Must Include Clear Audience Routing
...
## 30.3 Launch Must Represent Capability Status Accurately

Every launch page must be checked against:

```text
docs/product/PRODUCT_STATUS.md
```

No future capability may be presented as generally available.

---

## 30.4 Launch Must Establish Trust
...
## 30.5 Launch Must Support Conversion
...
## 30.6 Launch Must Meet Quality Requirements
...
## 30.7 Launch Must Avoid Incomplete Signals
...
# 31. Post-Launch Objectives

After launch, the website must evolve through evidence and controlled updates.

## 31.1 Measure Real Audience Behavior
...
## 31.3 Improve Conversion Responsibly
...
## 31.4 Maintain Product Alignment
...
## 31.5 Expand Content Deliberately
...
# 32. Website Success Metrics

Website success must be measured through understanding, trust, conversion, and operational quality.

## 32.1 Shared Success Metrics
...
## 32.6 Metric Interpretation

Metrics must be interpreted in context.

A high number of views does not independently indicate success.

A successful website must attract and support the correct audience, not only a large audience.

---

# 33. Website Decision Test

Before approving a page, section, component, or campaign, ask:

1. Who is the primary audience?
2. What must the visitor understand?
3. Which website objective does this support?
4. Does it reinforce the ODRISC product identity?
5. Does it communicate longitudinal value?
6. Does it accurately represent product status?
7. Is the clinical language responsible?
8. Does it strengthen Patient-Provider collaboration?
9. Is the level of detail appropriate?
10. Is the next action clear?
11. Is the experience accessible?
12. Is the content privacy-conscious?
13. Is it relevant to the visitor's market?
14. Can its performance impact be justified?
15. Does it duplicate an existing page?
16. Is there an identified owner and reviewer?
17. Can its effectiveness be measured?
18. Does it comply with the source-of-truth hierarchy?

A page or feature that fails these questions must not proceed to implementation without resolution.

---

# 34. Website Rules for AI Agents
...
Before performing website work, AI agents must review:
...
Relevant design, content, SEO, and engineering documents must also be reviewed.
...
# 35. Current Website Decisions, Open Questions, and Success Definition

## 35.1 Current Locked Website Decisions

The following decisions are currently locked:

1. The official public domain is `odrisc.com`.
2. ODRISC will operate one unified public website.
3. Patients and healthcare providers are both primary website audiences.
4. The website will provide an audience gateway.
5. The primary gateway choices are Patient and Healthcare Provider.
6. Patient and Provider journeys will remain within one domain.
7. Visitors must be able to switch between journeys.
8. Investors, media, careers, and general partners will not be primary gateway choices.
9. ODRISC will be positioned as a maternal and fetal intelligence platform.
10. Longitudinal understanding is the central website story.
11. The website must connect Patient and Provider experiences.
12. ODRISC must be presented as supportive of, not a replacement for, healthcare professionals.
13. Risk assessment must not be presented as diagnosis.
14. The website must distinguish current capabilities from roadmap capabilities.
15. Product status must be governed through `docs/product/PRODUCT_STATUS.md`.
16. Patient content must remain clear, supportive, and non-judgmental.
17. Provider content must remain clinically credible, precise, and workflow-oriented.
18. Weight-related messaging must avoid stigma and appearance-based language.
19. Artificial intelligence is an enabling capability, not the primary website identity.
20. Clinical safety takes priority over conversion.
21. Each significant page must have one primary objective and one primary CTA.
22. The website must support future Arabic localization.
23. Qatar is the primary planned commercial-market context.
24. The architecture must support future GCC expansion.
25. Accessibility must be included from the beginning.
26. Privacy must be treated as a website and product requirement.
27. The established visual identity uses white backgrounds, text color `#4d4d4d`, and the `#ff7680` to `#80ffcc` gradient.
28. The Patient and Provider experiences will share one design system.
29. Documentation must precede website application development.
30. AI-generated website work must follow the repository source of truth.

---

## 35.2 Website Questions Still to Be Resolved
...
## 35.3 Website Success Definition

The ODRISC website is successful when the following conditions are met.
...
## 35.4 Foundational Website Objective Summary

The ODRISC website must help Patients and healthcare providers understand one connected maternal and fetal intelligence platform through two audience-specific experiences.
...
↓
Longitudinal maternal and fetal understanding
↓
Earlier recognition
↓
More informed monitoring
...
Stronger Patient-Provider collaboration
↓
Better-supported maternal and fetal outcomes
```

The website must remain clear about product availability, clinical boundaries, privacy, evidence, and the role of healthcare professionals.

The website is not only a marketing surface.

It is the public system through which ODRISC establishes understanding, trust, relevance, and responsible action.
